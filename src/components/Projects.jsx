...
const projectList = [
  ...
  },
  {
    ...
    title: 'FitChicks',
    tech: ['Figma', 'GitHub', 'HTML5', 'JavaScript', 'Accessibility', 'CSS3', 'Adobe Photoshop', 'CSS', 'Webpack', 'Fetch API'],
    description:
  ...
  },
  {
    ...
    tech: ['Figma', 'GitHub', 'HTML5', 'JavaScript', 'Accessibility', 'TypeScript', 'React', 'CSS', 'React Router', 'Cypress', 'GitHub', 'Fetch API'],
    description:
...

  {
    ...
    title: "What's Cookin'?",
    tech: ['Figma', 'Git', 'HTML', 'JavaScript', 'Accessibility', 'CSS', 'Npm', 'CSS', 'Webpack', 'Mocha', 'Chai', 'Fetch API'],
    description:
  ...
  },
  {
    ...
    tech: ['Figma', 'GitHub', 'HTML5', 'JavaScript', 'Accessibility', 'CSS3', 'Adobe Photoshop', 'CSS', 'Webpack'],
    description:
